...
describe("getProductById handler", () => {
  ...
  it("should return status code 400 when pathParameters is undefined", async () => {
    const event = {};
    const result = await handler(event);
    expect(result.statusCode).toBe(400);
  });

  it("should return status code 400 when productId is undefined", async () => {
    const event = {
  ...
  it("should return status code 400 when productId is empty string", async () => {
    const event = {
  ...
  it("should return status code 400 when productId is null", async () => {
    const event = {
